package com.wei.wanandroid.alipush.component;
...
public class MyMessageIntentService extends AliyunMessageIntentService {
    ...
    protected void onNotification(Context context, String title, String summary, Map<String, String> extraMap) {
        ...
        WanApplication.setConsoleText("收到一条推送通知 ： " + title + ", summary:" + summary);
    }
    ...
    protected void onMessage(Context context, CPushMessage cPushMessage) {
        ...
        WanApplication.setConsoleText(cPushMessage.getTitle() + ", content:" + cPushMessage.getContent());
    }
    ...
    protected void onNotificationOpened(Context context, String title, String summary, String extraMap) {
        ...
        WanApplication.setConsoleText("onNotificationOpened ： " + " : " + title + " : " + summary + " : " + extraMap);
    }
    ...
    protected void onNotificationClickedWithNoAction(Context context, String title, String summary, String extraMap) {
        ...
        WanApplication.setConsoleText("onNotificationClickedWithNoAction ： " + " : " + title + " : " + summary + " : " + extraMap);
    }
    ...
    protected void onNotificationRemoved(Context context, String messageId) {
        ...
        WanApplication.setConsoleText("onNotificationRemoved ： " + messageId);
    }
    ...
    protected void onNotificationReceivedInApp(Context context, String title, String summary, Map<String, String> extraMap, int openType, String openActivity, String openUrl) {
        ...
        WanApplication.setConsoleText("onNotificationReceivedInApp ： " + " : " + title + " : " + summary);
    }
}
